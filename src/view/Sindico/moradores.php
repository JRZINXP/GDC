...
.card{
    ...
    padding:25px;box-shadow:0 10px 25px rgba(0,0,0,.08);
    margin-bottom:25px;
}
...
.btn-success:hover{background:#5b21b6;transform:translateY(-2px)}
...
<?php endwhile; else: ?>
<tr><td colspan="6" style="text-align:center">Nenhum morador</td></tr>
<?php endif; ?>
</tbody>
</table>
</div>
